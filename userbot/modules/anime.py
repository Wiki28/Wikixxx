...
@bot.on(wiki_cmd(outgoing=True, pattern=r"anilist ?(.*)"))
...
@bot.on(wiki_cmd(outgoing=True, pattern=r"anime ?(.*)"))
...
@bot.on(wiki_cmd(outgoing=True, pattern=r"manga ?(.*)"))
...
@bot.on(wiki_cmd(outgoing=True, pattern="a(kaizoku|kayo) ?(.*)"))
...
@bot.on(wiki_cmd(outgoing=True, pattern=r"char ?(.*)"))
...
@bot.on(wiki_cmd(outgoing=True, pattern="upcoming$"))
...
@bot.on(wiki_cmd(outgoing=True, pattern="whatanime$"))
